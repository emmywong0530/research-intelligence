...
export function App() {
  ...
  return (
    <AppShell page={page} onNavigate={navigate} connectionState={connectionState} connectionMessage={connectionMessage} onOpenOnboarding={() => setModal("onboarding")}>
      ...
      {page === "settings" ? <SettingsPage category={settingsCategory} onCategoryChange={setSettingsCategory} companionUrl={companionUrl} sessionToken={sessionToken} connectionState={connectionState} /> : null}
